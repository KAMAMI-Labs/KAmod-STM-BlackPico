...
/* USER CODE BEGIN PV */
volatile uint8_t *messPt;
volatile uint32_t messLen;
volatile uint32_t messFinish;


const uint8_t testMess[] = "KAmod BlackPico - STM32G030 mini evaluation board\n\r";
uint8_t messBuff[8];
...
/* USER CODE BEGIN 4 */
void LED_On(void){
	LL_GPIO_SetOutputPin(BlackPicoLED_GPIO_Port, BlackPicoLED_Pin);
}
